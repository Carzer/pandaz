...
import com.github.pandaz.redis.util.ServerConfig;
...
public class IndexController {
    ...
    public void onStartUp() {
        new RestTemplate().getForEntity(String.format("http://localhost:%s/wakeUp", serverConfig.getServerPort()), String.class);
    }
}
