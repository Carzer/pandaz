...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://172.16.2.130:3306/pandaz?useUnicode=true&useSSL=false&characterEncoding=utf8");
        ...
        pc.setParent("com.pandaz.usercenter");
        ...
        strategy.setSuperEntityColumns("created_by", "created_date", "updated_by", "updated_date", "deleted_date", "locked", "deleted_by"
//                ,"deleted_flag","version"
        );
        strategy.setNaming(NamingStrategy.underline_to_camel);
        strategy.setColumnNaming(NamingStrategy.underline_to_camel);
        strategy.setSuperEntityClass("com.pandaz.commons.entity.BaseEntity");
